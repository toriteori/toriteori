...
const LottoPlay: React.FC<LottoPlayProps> = ({
  ...
  const submitNumbers = () => {
    ...
    // 보너스 번호는 1~5 범위이므로 일반번호(1~20)와 겹칠 수 있음
  ...
  const generateNumbers = () => {
    ...
    // 보너스 번호는 1~10 중에서 자동 생성 (일반번호와 독립적)
    const bonusNum = Math.floor(Math.random() * 10) + 1;
    ...
    <div className="lotto-play">
      ...
      <div className="number-selection">
        <div className="selection-header">
          <h3>일반번호 1~10 중 6개 + 보너스 1~10 중 1개를 선택해주세요.</h3>
      ...
      <div className="game-instructions">
        <h4>📋 게임 방법</h4>
        <ul>
          <li>• 일반번호: 1~10 중에서 6개를 선택하세요</li>
          <li>• 보너스번호: 1~10 중에서 1개를 선택하세요</li>
          <li>• 실제 로또처럼 일반번호와 보너스번호가 겹쳐도 됩니다</li>
